...
export default function Home() {
  ...
  return (
    ...
    >
      {/* Ambient glow orbs visible behind content */}
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 w-full py-16 relative z-10">
        <div className="flex flex-col-reverse md:flex-row items-center justify-between gap-12">
          ...
          >
            ...
            >
              Backend Developer with 2+ years building scalable systems
              with Java & Spring Boot, deploying cloud-native solutions
              on AWS & Azure, with working knowledge of React & TypeScript.
            </p>
